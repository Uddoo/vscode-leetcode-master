    ...
    public provideCodeLenses(document: vscode.TextDocument): vscode.ProviderResult<vscode.CodeLens[]> {
        ...
        if (shortcuts.indexOf("submit") >= 0) {
            codeLens.push(new vscode.CodeLens(range, {
                title: "Submit",
                command: "leetcodeMaster.submitSolution",
        ...
        if (shortcuts.indexOf("test") >= 0) {
            codeLens.push(new vscode.CodeLens(range, {
                title: "Test",
                command: "leetcodeMaster.testSolution",
                arguments: [document.uri],
            }));
        }
        ...
        if (shortcuts.indexOf("star") >= 0 && node) {
            codeLens.push(new vscode.CodeLens(range, {
                ...
                command: node.isFavorite ? "leetcodeMaster.removeFavorite" : "leetcodeMaster.addFavorite",
                arguments: [node],
            }));
        }
        ...
        if (shortcuts.indexOf("solution") >= 0) {
            codeLens.push(new vscode.CodeLens(range, {
                title: "Solution",
                command: "leetcodeMaster.showSolution",
                arguments: [document.uri],
            }));
        }
        ...
        if (shortcuts.indexOf("description") >= 0) {
            codeLens.push(new vscode.CodeLens(range, {
                title: "Description",
                command: "leetcodeMaster.previewProblem",
                arguments: [document.uri],
            }));
        }
